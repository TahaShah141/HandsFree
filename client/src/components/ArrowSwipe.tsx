...
type ArrowSwipeProps = {
  changeState: (s: string) => void;
}

export const ArrowSwipe = ({changeState}: ArrowSwipeProps) => {
  return (
    <div className="size-full flex flex-col gap-4 relative py-8">
      <div onClick={() => changeState("KEYBOARD")} className="size-full bg-neutral-950 text-neutral-700 rounded-xl flex flex-col gap-2 justify-center items-center">
      ...
      <MusicControls 
        className="h-20 w-full justify-evenly rounded-xl bg-neutral-950 text-neutral-700" 
